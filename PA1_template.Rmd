...
```{r}
hist(activity_date$steps, xlab="Total number of steps taken each day", main="Total number of steps taken each day")
```
...
hist(activity_all_date$steps, xlab="Total number of steps taken each day", main="Total number of steps taken each day")
```
